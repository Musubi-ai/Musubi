...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", default="古典音樂欣賞筆記（樂品越樂）", help="webiste name and its corresponding directory", type=str)
    parser.add_argument("--name", default="樂品越樂所有文章", help="category of articels in the website", type=str)
    parser.add_argument("--lang", default="中文", help="main language of the website", type=str)
    parser.add_argument("--prefix", default="https://feelmusic.com.tw/page/", help="prefix 1", type=str)
    ...
    parser.add_argument("--pages", default=48, help="pages of websites", type=int)
