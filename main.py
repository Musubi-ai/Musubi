...
parser.add_argument("--dir", default="易律網", help="webiste name and its corresponding directory", type=str)
parser.add_argument("--name", default="易律網最新文章", help="category of articels in the website", type=str)
parser.add_argument("--class_", default="中文", help="main class of the website", type=str)
parser.add_argument("--prefix", default="https://ezlawyer.tw/posts/", help="prefix 1", type=str)
parser.add_argument("--prefix2", default="#anchor_link", help="prefix 2", type=str)
parser.add_argument("--prefix3", default="https://ezlawyer.tw", help="prefix 3", type=str)
parser.add_argument("--pages", default=63, help="pages of websites", type=int)
parser.add_argument("--block1", default=["div", "relative rounded border border-neutral-300 p-6 shadow-md bg-white"], help="main list of tag and class", type=list)
