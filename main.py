...
parser.add_argument("--dir", default="打狗高雄", help="webiste name and its corresponding directory", type=str)
parser.add_argument("--name", default="打狗高雄所有文章", help="category of articels in the website", type=str)
parser.add_argument("--class_", default="中文", help="main class of the website", type=str)
parser.add_argument("--prefix", default="https://takao.tw/page/", help="prefix of url", type=str)
...
parser.add_argument("--pages", default=23, help="pages of websites", type=int)
