...
parser.add_argument("--dir", default="台灣回憶探險團", help="webiste name and its corresponding directory", type=str)
parser.add_argument("--name", default="台灣回憶探險團所有文章", help="category of articels in the website", type=str)
parser.add_argument("--class_", default="中文", help="main class of the website", type=str)
parser.add_argument("--prefix", default="https://www.twmemory.org/?paged=", help="prefix of url", type=str)
...
parser.add_argument("--pages", default=80, help="pages of websites", type=int)
parser.add_argument("--block1", default=['span', 'cm-post-date'], help="main list of tag and class", type=list)
