...
parser.add_argument("--name", default="下班生活", help="category of articels in the website", type=str)
parser.add_argument("--class_", default="中文", help="main class of the website", type=str)
parser.add_argument("--prefix", default="https://www.518.com.tw/articles/category/life/", help="prefix 1", type=str)
